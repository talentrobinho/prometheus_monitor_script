...
class ConnRedis(object):
    ...
    @classmethod
    def conn_redis(cls):
        redis_node_list = [{'host': '10.134.21.159', 'port': '7001'},
                           {'host': '10.134.21.159', 'port': '7002'},
                           {'host': '10.134.17.138', 'port': '7001'},
                           {'host': '10.134.17.138', 'port': '7002'},
                           {'host': '10.134.11.188', 'port': '7001'},
                           {'host': '10.134.11.188', 'port': '7002'}]

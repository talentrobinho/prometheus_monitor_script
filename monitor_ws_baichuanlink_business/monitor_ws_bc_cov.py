...
class MonitorWSBCCOV(object):
	...
	def wsbc_cov(cls, data):
		...
		for h in machine_pv:
			...
			ws_bc_server_cov.labels(region, province, ip, '1').set(machine_cov)
		...
		for r in region_pv:
			...
			ws_bc_server_cov.labels(region, province, ip, '1').set(region_cov)
